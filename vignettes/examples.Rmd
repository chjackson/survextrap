...
But note that it is only necessary to extrapolate in this way, using knots and default priors, if there is **no sunatantive information** about the long term hazard!
...
The idea of the package is to make this information as explicit as possible - ideally in the form of data. 
