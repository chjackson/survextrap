...
```{r modcomp, class.source = 'fold-hide', eval=FALSE}
dfs <- 5:12
...
```{r latex_table_trt,echo=FALSE,eval=FALSE,results="hide"}
...
```{r modcomp_seer, cache=TRUE, echo=FALSE, eval=FALSE}
...
```{r latex_table_rs,echo=FALSE,eval=FALSE,results="hide"}
## Table in LaTeX format for the paper
...
```{r latex_wane, echo=FALSE, eval=FALSE, results="hide"}
