...
See the [home page](https://chjackson.github.io/survextrap) for the design principles of the package, and the [examples vignette](examples.html) for examples of how to fit models and summarise model outputs. 
...
A log-normal prior is used for the scale $\eta$.   The default in the package is a normal with mean 0 and SD 20 for $\log(\eta)$. 
