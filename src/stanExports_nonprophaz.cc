...
#include "stanExports_nonprophaz.h"

RCPP_MODULE(stan_fit4nonprophaz_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_nonprophaz")
